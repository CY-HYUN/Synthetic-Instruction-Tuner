...
### 1.4 예산
- **목표 예산**: $0 (완전 무료 - Colab T4)
- **최대 허용 예산**: $10 (Colab Pro 1개월 - A100, 선택사항)
- **A100 사용 시 이점**: 전체 파이프라인 2-3배 빠름 (33-43시간 → 13-20시간)
...
#### 3.1.3 개발 환경
- **Primary**: Google Colab Free (T4 GPU, 16GB VRAM, 무료)
- **Recommended**: Colab Pro (A100 GPU, 40GB VRAM, $10/월) - **2-3배 빠름**
- **Local**: VSCode + Python

**A100 최적화 적용**:
- SFT 배치 사이즈: 4 → 12 (3배)
- DPO 배치 사이즈: 2 → 8 (4배)
- 체크포인트 간격: 20 → 100 (디스크 I/O 감소)
